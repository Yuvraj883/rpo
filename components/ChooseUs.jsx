const ChooseUs = ()=>{
  return(
    <>
    <div className="md:grid md:grid-cols-3 flex-col gap-6 bg-white m-0 md:px-12  md:py-6">

      <section className="text-red-700 hover:scale-110  col-span-1 mt-2 mb-4 flex-col items-center justify-center shadow-lg md:px-6 py-2 ">
      ...
      <section className="text-red-700 hover:scale-110 col-span-1 mt-2 flex-col items-center justify-center shadow-lg px-6 py-2 ">
